...
<main class="sheet">
    ...
    <div class="actions"><a href="<?= esc($navigationBackUrl, 'attr') ?>"><?= esc(lang('Admin.backToQueue')) ?></a><a href="/admin?lang=<?= esc($locale, 'attr') ?>"><?= esc(lang('Admin.navDashboard')) ?></a><button type="button" onclick="window.print()"><?= esc(lang('Admin.printNow')) ?></button></div>
</main>
