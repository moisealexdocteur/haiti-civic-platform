...
$eventLabels = [
    ...
    'settings.communication_channel_validated' => lang('Admin.eventChannelValidated'),
    'settings.communication_channel_test_failed' => lang('Admin.eventChannelTestFailed'),
    'settings.communication_channel_deleted' => lang('Admin.eventChannelDeleted'),
